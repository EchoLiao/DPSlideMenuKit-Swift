...
// MARK: Constant
let kDPDrawerButtonRect: CGRect = CGRect(x: 14.0, y: 26.0, width: 30.0, height: 30.0)
let kDPDrawerButtonRect_iPhoneX: CGRect = CGRect(x: 14.0, y: 46.0, width: 30.0, height: 30.0)
